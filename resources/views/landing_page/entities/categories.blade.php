...
@section('title', 'Magento Categories for CMS Page')
...
@section('content')
    ...
    <section>
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    <h3>Magento Categories for CMS page</h3>
                    <div class="col-sm-2">
                    ...
                    {{ Form::open(['route' =>'landingPage.store.category','class'=>'form form-validate', 'novalidate']) }}
